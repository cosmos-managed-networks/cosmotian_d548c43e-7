...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.cosmotian" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.cosmotian" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.cosmotian"}")
export BINARY=${BINARY:-cosmotiand}
export DENOM=${DENOM:-cosmotian}
...
from_scratch () {
  ...
  # cosmotian1efd63aw40lxf3n4mhf7dzhjkr453axuryax6x9
  ...
  # cosmotian1hj5fveer5cjtn4wd6wstzugjfdxzl0xpcf470v
